...
Revision ID: a382d7029240
Revises: 
Create Date: 2023-03-19 22:16:51.301718
...
def upgrade() -> None:
    ...
    op.create_table('transaction_target',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_transaction_target_id'), 'transaction_target', ['id'], unique=False)
    op.create_index(op.f('ix_transaction_target_name'), 'transaction_target', ['name'], unique=True)
    op.create_table('unit',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('ratio_with_standard', sa.DOUBLE(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['transaction_target_id'], ['transaction_target.id'], ),
    ...
    op.create_index(op.f('ix_item_transaction_target_id'), 'item', ['transaction_target_id'], unique=False)
    ...
    op.create_index(op.f('ix_payment_method_family_id'), 'payment_method', ['family_id'], unique=False)
