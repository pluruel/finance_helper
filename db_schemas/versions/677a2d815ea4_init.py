...
Revision ID: 677a2d815ea4
Revises: 
Create Date: 2023-04-01 19:25:23.225400
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("name", sa.String(), nullable=True),
        sa.Column("tax_deduction_rate", sa.Float(), nullable=True),
        sa.Column("family_id", sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(
            ["family_id"],
            ["family.id"],
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("name", "family_id", name="payment_mtd_name_family_id"),
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_payment_method_name"), "payment_method", ["name"], unique=False
    )
    op.create_table(
        "price",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("date", "value", name="price_date_cost"),
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("transaction_target_item")
